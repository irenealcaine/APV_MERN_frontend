...
const CambiarPasssword = () => {
  ...
  const handleSubmit = async e => {
    ...
    if (password.pwd_nueva.length < 6) {
      setAlerta({
        msg: 'La contraseña debe tener al menso 6 carácteres', error: true
      })
      return
    }
  ...
  return (
    <>
      ...
      <p className="text-xl mt-5 mb-10 text-center">Modifica aquí tu <span className="text-indigo-600 font-bold">contraseña</span></p>
...
export default CambiarPasssword
