...
const EditarPerfil = () => {
  ...
  const handleSubmit = async e => {
    ...
    if ([nombre, email].includes('')) {
      setAlerta({
        msg: 'Nombre e email obligatorios', error: true
      })
      return
    }
  ...
  return (
    <>
      ...
      <p className="text-xl mt-5 mb-10 text-center">Modifica aquí tu <span className="text-indigo-600 font-bold">información</span></p>
